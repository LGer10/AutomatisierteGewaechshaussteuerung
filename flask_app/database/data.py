...
VALUES (1, 20, 10, 80, 70, current_date() -4, current_time())''')
cursor.execute('''insert into sensordata (id_satellite_programm, temperature, brightness, airhumidity, soilhumidity, date, time) 
VALUES (1, 10, 8, 40, 60, current_date() - 3, current_time())''')
cursor.execute('''insert into sensordata (id_satellite_programm, temperature, brightness, airhumidity, soilhumidity, date, time) 
VALUES (1, 20, 6, 60, 40, current_date() - 2, current_time())''')
cursor.execute('''insert into sensordata (id_satellite_programm, temperature, brightness, airhumidity, soilhumidity, date, time) 
VALUES (1, 30, 5, 50, 20, current_date() - 1, current_time())''')
cursor.execute('''insert into sensordata (id_satellite_programm, temperature, brightness, airhumidity, soilhumidity, date, time) 
VALUES (1, 25, 8, 60, 50, current_date(), current_time())''')
