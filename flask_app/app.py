...
def dashboard():
    ...
    if request.method == 'POST' and request.form['loadButton'] == 'Laden':
        ...
        return render_template('dashboard.html', satellite_list=satellite_list, programm_list=programm_list, dates=dates, date_span=date_span, temperature_list=temperature_list, dates_list=dates_list, times_list=times_list, brightness_list=brightness_list, airhumidity_list=airhumidity_list, soilhumidity_list=soilhumidity_list, displayed_satellite=displayed_satellite, displayed_programm=displayed_programm, temperature_value=temperature_value, brightness_value=brightness_value, airhumidity_value=airhumidity_value, soilhumidity_value=soilhumidity_value)
